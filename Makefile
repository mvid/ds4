...
test: ds4_test ds4_agent_test ds4-eval q4k-dot-test mxfp4-dot-test test-session-state test-linux-memory test-engram test-web-recovery \
	...
	tests/test_deepseek4_vision_image tests/test_image_decode tests/test_prompt_prefix tests/test_tokenizer $(SAMPLING_TEST) ds4 ds4-server ds4-bench ds4-agent
